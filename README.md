...
以下内容来自[简体中文版](https://github.com/ryanhanwu/How-To-Ask-Questions-The-Smart-Way/blob/main/README-zh_CN.md)。为便于阅读，本文对部分语句进行了调整和修改。  

Copyleft 2001 by D.H.Grand(nOBODY/Ginux), 2010 by Gasolin, 2015 by Ryan Wu    
中文翻译仓库网址：[https://github.com/ryanhanwu/How-To-Ask-Questions-The-Smart-Way](https://github.com/ryanhanwu/How-To-Ask-Questions-The-Smart-Way)。    
...
我们已经深刻领悟到了由于缺少上述声明所带来的痛苦：我们不停地被那些认为发布这本指南就意味着有责任解决世上所有技术问题的傻瓜纠缠。  

如果你因寻求某些帮助而碰巧阅读到了本指南（指《提问的智慧》一文），并在离开时还觉得可以从本文作者 (指 Eric S. Raymond, Rick Moen) 这里得到直接帮助，那你就是我们之前说的那些傻瓜之一。   
别问我们问题，我们只会忽略你。  
我们在这本指南中想教你如何从那些真正懂得你所遇到的软件或硬件问题的人处取得协助，而 99% 的情况下那不会是我们。  
除非你确定本指南的作者之一刚好是你所遇到的问题领域的专家，否则请不要打扰我们，这样大家都会开心一点。  

## 简介

在[黑客](http://www.catb.org/~esr/faqs/hacker-howto.html)的世界里，你所提技术问题的解答的好坏，很大程度上取决于你提问的方式与此问题的难度。本指南将教你如何正确地提问以获得你满意的答案。

现在开源（Open Source）软件已经相当盛行，您通常可以从其他更有经验的用户那里获得与黑客一样好的答案，这是件**好事**；和黑客相比，用户们往往对那些新手常遇到的问题更宽容一些。  
不过，按照本文推荐的方式与这些有经验的用户交流，仍然是从他们那里获得有用帮助的最佳途径。

首先你要明白一点：黑客们热衷于富有挑战性的问题，尤其是那些能激发他们思维的好问题。正因如此，黑客们才成为了你想询问的对象。  
相反，如果你提出了一个值得深入思考和探讨的问题，我们会由衷地感谢你。对我们来说，好问题就像一份珍贵的礼物，是一种激励。它不仅能拓展我们的认知边界，还常常能揭示一些我们之前从未注意或思考过的盲点。这就是为什么在黑客社区中，"好问题！"被视为最真诚的赞美。

虽然黑客们常被认为对简单问题抱有轻蔑或傲慢的态度，看起来对新手和知识欠缺者不太友善，但事实并非如此。

我们坦率地承认，我们确实会蔑视那些懒于思考、不愿在提问前做足功课的人。这些人就像时间黑洞一样 —— 他们只索取不付出，浪费了我们本可以用来解答更有价值的问题、帮助更值得帮助的人的宝贵时间。在黑客社区中，我们称这类人为"失败者（loser）"（由于历史原因，有时也写作"lusers"）。
...
我们都是志愿从繁忙的生活中抽出宝贵时间来解答问题的，从未获得任何汇报。每天收到大量提问时，不得不有所取舍。为了更有效地利用时间，我们会优先回答那些展现出积极学习态度和思考能力的人——赢家（winner）的问题，而对于那些不愿付出努力、只想索取答案的提问者——失败者（loser），我们则会婉拒。这不是傲慢，而是为了确保有限的时间和精力能够帮助到真正需要且值得帮助的人。

如果你厌恶我们的态度，认为我们高高在上，或过于傲慢，不妨也设身处地想想。我们并没有要求你向我们屈服 —— 事实上，我们大多数人非常乐意与你平等地交流，只要你付出小小努力来满足基本要求，我们就会欢迎你加入我们的文化。但让我们帮助那些不愿意帮助自己的人是没有效率的。无知没有关系，但装白痴就是不行。
...
（欢迎对本指南提出改进意见。你可以把你的建议发送至 [esr@thyrsus.com](mailto:esr@thyrsus.com) 或 [espond-auto@linuxmafia.com](mailto:espond-auto@linuxmafia.com)。然而请注意，本文并非[网络礼节](http://www.ietf.org/rfc/rfc1855.txt)的通用指南，而我们通常会拒绝无助于在技术论坛得到有用答案的建议）。 
...
在提出问题时，请务必说明你已完成上述准备工作。这不仅能表明你尊重他人的时间，也能避免给人留下懒惰、不负责任的印象。更重要的是，如果你能分享在这个过程中的收获和思考，会让人更愿意帮助你。因为我们更倾向于回答那些善于学习、愿意思考的人的问题。
...
别着急，不要指望几秒钟的 Google 搜索就能解决一个复杂的问题。
...
绝不要自以为**够格**得到答案，你没有；你并没有。毕竟你没有为这种服务支付**任何报酬**。你将会靠自己提出有内涵的、有趣的、有思维激励作用的问题 —— 一个有潜力能贡献社区经验的问题去**挣到**一个答案，而不仅仅是被动地从他人处索取知识。
